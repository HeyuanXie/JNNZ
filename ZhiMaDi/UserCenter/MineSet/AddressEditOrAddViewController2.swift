...
import UIKit
//编辑或增加收货地址
class AddressEditOrAddViewController2: UIViewController,UITableViewDataSource,UITableViewDelegate,ZMDInterceptorProtocol,ZMDInterceptorNavigationBarShowProtocol,ZMDInterceptorMoreProtocol {
    ...
    var isAdd : Bool = true
    let titles = ["收件人 : ","手机号码 : ","所在地区 : ","街道地址 : ","设为默认地址 : "]
    ...
    private func checkData() -> Bool {
        if usrNameTextFidld.text == nil || usrNameTextFidld.text == "" {
            ...
            return false
        }  else if areaLbl.text == nil || areaLbl.text == "省/市/区" {
            //当areaLbl.text==nil或“省/市/区”时都是没有选择地区
