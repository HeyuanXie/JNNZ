...
//                ShareSDK.showShareActionSheet(<#T##view: UIView!##UIView!#>, items: <#T##[AnyObject]!#>, shareParams: <#T##NSMutableDictionary!#>, onShareStateChanged: <#T##SSUIShareStateChangedHandler!##SSUIShareStateChangedHandler!##(SSDKResponseState, SSDKPlatformType, [NSObject : AnyObject]!, SSDKContentEntity!, NSError!, Bool) -> Void#>)
